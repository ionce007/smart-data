            ...
            `}
                    ...
                    {showFloatingMenu && (
                      ...
                      `}
                                        >
                                            <svg
                                                className={`mr-3 h-5 w-5 flex-shrink-0 ${router.pathname === child.path ? 'text-blue-500' : 'text-gray-400'
                                                    }`}
                                                fill="none"
                                                stroke="currentColor"
                                                viewBox="0 0 24 24"
                    ...
                    `}
                                    >
                                        <svg
                                            className={`mr-3 h-5 w-5 flex-shrink-0 ${router.pathname === item.path ? 'text-blue-500' : 'text-gray-400'
                                                }`}
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
